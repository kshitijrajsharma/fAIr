...
export const ENVS = {
  ...
  MAX_TRAINING_AREA_UPLOAD_FILE_SIZE: import.meta.env.VITE_MAX_TRAINING_AREA_UPLOAD_FILE_SIZE,
  ...
  TRAINING_AREAS_AOI_FILL_COLOR: import.meta.env.VITE_TRAINING_AREAS_AOI_FILL_COLOR,

  TRAINING_AREAS_AOI_OUTLINE_COLOR: import.meta.env.VITE_TRAINING_AREAS_AOI_OUTLINE_COLOR,

  TRAINING_AREAS_AOI_OUTLINE_WIDTH: import.meta.env.VITE_TRAINING_AREAS_AOI_OUTLINE_WIDTH,

  TRAINING_AREAS_AOI_FILL_OPACITY: import.meta.env.VITE_TRAINING_AREAS_AOI_FILL_OPACITY,

  TRAINING_AREAS_AOI_LABELS_FILL_OPACITY: import.meta.env.VITE_TRAINING_AREAS_AOI_LABELS_FILL_OPACITY,

  TRAINING_AREAS_AOI_LABELS_OUTLINE_WIDTH: import.meta.env.VITE_TRAINING_AREAS_AOI_LABELS_OUTLINE_WIDTH,

  TRAINING_AREAS_AOI_LABELS_FILL_COLOR: import.meta.env.VITE_TRAINING_AREAS_AOI_LABELS_FILL_COLOR,

  TRAINING_AREAS_AOI_LABELS_OUTLINE_COLOR: import.meta.env.VITE_TRAINING_AREAS_AOI_LABELS_OUTLINE_COLOR,
  ...
  MAX_GEOJSON_FILE_UPLOAD_FOR_TRAINING_AREA_LABELS: import.meta.env.VITE_MAX_GEOJSON_FILE_UPLOAD_FOR_TRAINING_AREA_LABELS,

  MAX_GEOJSON_FILE_UPLOAD_FOR_TRAINING_AREAS: import.meta.env.VITE_MAX_GEOJSON_FILE_UPLOAD_FOR_TRAINING_AREAS,

  MAX_ACCEPTABLE_POLYGON_IN_TRAINING_AREA_GEOJSON_FILE: import.meta.env.VITE_MAX_ACCEPTABLE_POLYGON_IN_TRAINING_AREA_GEOJSON_FILE,
