        ...
        <h1 className="w-72 text-[200px] lg:w-[450px] lg:text-[450px] flex items-center justify-center font-semibold text-light-gray relative">
          ...
          <span className="absolute flex items-center w-full justify-center h-full">
            ...
            >
              ...
              />
              <path
                d="M284.424 135.982L359.272 192.915L359.971 77.8621L311.582 37.7324L284.424 135.982Z"
                fill="#D63F40"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M172.899 8.42335L185.592 19.9675L178.544 39.252L189.796 43.6536L183.449 66.8856L198.822 78.1181L188.954 97.903L206.911 104.023L203.309 117.891L120.514 120.295L121.659 12.82L172.899 8.42335Z"
                fill="#D63F40"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M212.815 126.458L212.764 126.374L224.193 116.472L212.87 101.251L232.215 90.5464L225.918 72.5779L244.318 57.0381L237.543 47.0331L254.282 35.1424L251.511 23.3072L311.585 37.7313L284.438 135.973L212.815 126.458Z"
                fill="#D33132"
              />
            </svg>
          </span>
